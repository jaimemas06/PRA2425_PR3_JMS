...
bin/testHashTable: testHashTable.cpp HashTable.h Dict.h TableEntry.h ../PRA2425_PR1_JMS/ListLinked.h
	mkdir -p bin
	g++ -o bin/testHashTable testHashTable.cpp HashTable.h Dict.h TableEntry.h ../PRA2425_PR1_JMS/ListLinked.h
